...
trigger2 = numhelper(1298) >= 1
trigger3 = numhelper(1297) >= 1

value = ifelse(statetype = A,961,960)
ignorehitpause = 1
...
trigger2 = time = [14,18]
trigger3 = stateno = 1500 || stateno = 1550
trigger3 = animelemtime(10) = [0,2]
...
triggerall = statetype != A
trigger1 = (stateno = [200,799]) && (movecontact||movereversed||fvar(28))
...
trigger2 = stateno = 52 || var(58)=1&&stateno=100
...
triggerall = var(25) = 0
triggerall = power >= 1000
triggerall = command = "直下型ダンディー"
trigger1 = statetype = A
trigger1 = (ctrl||fvar(28))
trigger2 = (stateno = [600,650]) && (movecontact||movereversed||var(6)) && var(3) = 0
trigger2 = (var(58)=2&&stateno != 600&&stateno != 615)|var(58)!=2
...
[State -1, 3100]
type = ChangeState
value = ifelse(var(58)=1,3300,3100)
triggerall = var(59) <= 0
triggerall = var(40) = 0
triggerall = !ishelper
triggerall = var(25) = 0
triggerall = power >= 1000
triggerall = command = "永遠の翼"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28)) || (StateNo = 5120 && animtime = 0)
trigger2 = var(3) = 0
trigger2 = ((stateno = [200,451])&&var(58)!=2 || ((stateno = [220,230])||stateno = 420)&&var(58)=2) && (movecontact||movereversed)
trigger2 = stateno != 205 && stateno != 215 && (stateno != [240,242]) && stateno != 430 && stateno != 450||(var(58)=1&&stateno = 450)

trigger3 = stateno = 40 || stateno = 52 || var(58)=1&&stateno=100
trigger4 = stateno = [195, 197]
trigger4 = time > ifelse(anim = 196,18,64)

trigger5 = (stateno = [200,451]) && var(29)
trigger5 = stateno != [241,242]

trigger6 = numhelper(780+id)
trigger6 = helper(780+id),sysvar(0)
trigger6 = stateno = 151 || stateno = 153 || (stateno = 155 && statetype != A)
...
trigger2 = stateno = 40 || stateno = 52 || var(58)=1&&stateno=100
...
[State -1]
type = ChangeState
value = 1300 + (var(58)=2)*10
triggerall = var(59) <= 0
triggerall = !ishelper
triggerall = var(43) != 1
triggerall = command = "アンダートウ"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28))
trigger2 = var(3) = 0
trigger2 = ((stateno = [200,451])&&var(58)!=2 || ((stateno = [220,230])||stateno = 420)&&var(58)=2) && (movecontact||movereversed)
...
triggerall = power >= 500
triggerall = !ishelper
triggerall = command = "z"||command = "!hold_z"
triggerall = movetype != H
trigger1 = stateno = 1000
trigger1 = time >= 15
trigger2 = stateno = 1010
...
triggerall = var(59) <= 0
triggerall = !ishelper
triggerall = command = "a"||command = "!hold_a"
triggerall = movetype != H
trigger1 = stateno = 1000
trigger1 = time >= 15
trigger2 = stateno = 1010
...
triggerall = var(58) != 2
triggerall = !ishelper
triggerall = command = "b"||command = "!hold_b"
triggerall = movetype != H
trigger1 = stateno = 1000
trigger1 = time >= 15
trigger2 = stateno = 1010
...
[State -1]
type = ChangeState
value = ifelse(var(58)=1,2000,1000)
triggerall = var(59) <= 0
triggerall = !ishelper
triggerall = command = "Dステップ_P"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28)) || (StateNo = 5120 && animtime = 0)
trigger2 = var(3) = 0
trigger2 = ((stateno = [200,451])&&var(58)!=2 || ((stateno = [220,230])||stateno = 420)&&var(58)=2) && (movecontact||movereversed)
...
[State -1]
type = ChangeState
value = ifelse(var(58)=1,2100,1010)
triggerall = var(59) <= 0
triggerall = !ishelper
triggerall = command = "Dステップ_K"
trigger1 = statetype != A
...
trigger5 = (stateno = [950,969]) && statetype != A
trigger5 = time = 1
...
trigger6 = (stateno = [950,969]) && statetype != A
trigger6 = time = 1
...
triggerall = p2bodydist X < 56 - (var(58)=2)*11
...
trigger1 = (movecontact||movereversed)
trigger1 = var(58) = 0
trigger1 = stateno = 200||stateno = 210||stateno = 220||stateno = 230||(stateno = [400,420])
trigger2 = (movecontact||movereversed)
trigger2 = var(58)=1
trigger2 = stateno = 200||stateno = 205||stateno = 210||stateno = 220||stateno = 225||stateno = 230||(stateno = [400,420])

trigger3 = (movecontact||movereversed)
trigger3 = var(58)=2
trigger3 = stateno = 230||(stateno = 410&&(time=[10,13]))||(stateno = 420&&(time=[10,20]))
...
trigger4 = var(29)
trigger4 = var(58) = 0
trigger4 = stateno = 200||stateno = 210||stateno = 220||stateno = 230||(stateno = [400,420])
trigger5 = var(29)
trigger5 = var(58)=1
trigger5 = stateno = 200||stateno = 205||stateno = 210||stateno = 220||stateno = 225||stateno = 230||(stateno = [400,420])

trigger6 = var(29)
trigger6 = var(58)=2
trigger6 = stateno = 230||(stateno = 410&&(time=[10,13]))||(stateno = 420&&(time=[10,20]))
...
trigger2 = var(58)=0
trigger2 = (movecontact||movereversed)
trigger2 = command != "down_z"
trigger2 = stateno = 225

trigger3 = (movecontact||movereversed)
trigger3 = var(58)=1
trigger3 = stateno = 200||stateno = 205||stateno = 210||stateno = 220||stateno = 225||stateno = 230||(stateno = [400,420])
...
trigger5 = command != "down_z"
trigger5 = stateno = 200||stateno = 210||stateno = 220||stateno = 225||stateno = 400

trigger6 = (movecontact||movereversed)
trigger6 = var(58)=2
trigger6 = (stateno = 410&&(time=[10,13]))||(stateno = 420&&(time=[10,20]))
...
trigger2 = stateno = [195, 197]
trigger2 = time > ifelse(anim = 196,18,64)
trigger3 = stateno = 12||stateno = 52 || var(58)=1&&stateno=100

trigger4 = var(58)=0
trigger4 = stateno = 200||stateno = 210||(stateno = [220,230])||(stateno = [400,420])
trigger4 = var(29)
...
trigger6 = var(58)=2
trigger6 = stateno = 200||stateno = 210||(stateno = [220,230])||stateno = 400
trigger6 = var(29)

trigger7 = var(29)
trigger7 = var(58)=2
trigger7 = (stateno = 410&&(time=[10,13]))||(stateno = 420&&(time=[10,20]))
...
trigger1 = statetype = S
trigger1 = (ctrl||fvar(28))
trigger2 = var(58)=0&&(stateno = 200||stateno = 210||stateno = 220)||var(58)=1&&(stateno = [200,220])&&stateno != 205&&stateno != 215
trigger2 = (movecontact||movereversed)&&var(3) = 0
trigger3 = var(58)=0&&stateno = 410||var(58)=1&&(stateno = [400,410])||var(58)=2&&(stateno = 200||stateno = 210||stateno = 400)
trigger3 = (movecontact||movereversed)&&var(3) = 0
trigger4 = stateno = [195, 197]
trigger4 = time > ifelse(anim = 196,18,64)
trigger5 = stateno = 12||stateno = 52 || var(58)=1&&stateno=100
...
triggerall = command = "x"
triggerall = var(3) = 0
trigger1 = stateno = 200 && var(58)!=2||stateno = 400 && var(58)!=2
trigger1 = (movecontact||movereversed)
...
triggerall = var(3) = 0
trigger1 = stateno = 200 && var(58)!=2 || var(58)=1&&stateno = 400
trigger1 = (movecontact||movereversed)
...
trigger1 = statetype = C
trigger1 = (ctrl||fvar(28))
trigger2 = stateno = [195, 196]
trigger2 = time > ifelse(anim = 196,20,63)
trigger3 = stateno = 12||stateno = 52 || var(58)=1&&stateno=100
...
trigger2 = stateno = 220 && var(58)!=2 || (var(58)=0&&stateno = 420)||stateno = 210 && var(58)=2
trigger2 = (movecontact||movereversed)&&var(3) = 0

trigger3 = stateno = [195, 197]
trigger3 = time > ifelse(anim = 196,18,64)
trigger4 = stateno = 12||stateno = 52 || var(58)=1&&stateno=100


trigger5 = (movecontact||movereversed)
trigger5 = var(58)=2
trigger5 = (stateno = 420&&(time=[10,20]))
...
triggerall = var(3) = 0
trigger1 = (var(58)=0&&stateno = 400)||var(58)=1&&(((stateno = [200,225])&&stateno != 215)||(stateno = [400,410]))
trigger1 = var(58)!=2
trigger1 = (movecontact||movereversed)
trigger2 = var(58)=2
trigger2 = (movecontact||movereversed)
trigger2 = (stateno = 410&&(time=[10,13]))
...
triggerall = var(3) = 0
triggerall = var(58)=1
trigger1 = (stateno = [200,210]) && var(58)!=2
trigger1 = (movecontact||movereversed)
trigger2 = (stateno = [400,410]) && var(58)!=2
trigger2 = (movecontact||movereversed)
...
triggerall = command = "y"
triggerall = var(3) = 0
trigger1 = stateno = 220||var(58)=1&&(p2bodydist X > 44||p2bodydist X < -44)&&((stateno = [200,210])||(stateno = [400,410]))
trigger1 = (movecontact||movereversed)
...
triggerall = command = "y"
triggerall = command != "holddown"
triggerall = p2bodydist X > 44 || p2bodydist X < -44
trigger1 = statetype = S
trigger1 = (ctrl||fvar(28))
trigger2 = stateno = [195, 197]
trigger2 = time > ifelse(anim = 196,18,64)
...
triggerall = var(3) = 0
trigger1 = (var(58)=0&&stateno = 230)||var(58)=1&&(((stateno = [200,225])&&stateno != 215)||(stateno = [400,420]))
trigger1 = (movecontact||movereversed)

trigger2 = var(58)=2
trigger2 = (movecontact||movereversed)
trigger2 = (stateno = 410&&(time=[10,13]))||(stateno = 420&&(time=[10,20]))
...
trigger1 = statetype = S
trigger1 = (ctrl||fvar(28))
trigger2 = var(58)=0&&(stateno = 200||stateno = 210||stateno = 220)||var(58)=1&&(stateno = 200||stateno = 205)
trigger2 = (movecontact||movereversed) && var(3) = 0
trigger3 = stateno = [195, 197]
trigger3 = time > ifelse(anim = 196,18,64)
trigger4 = stateno = 12||stateno = 52 || var(58)=1&&stateno=100
...
triggerall = command = "b"
triggerall = var(3) = 0
trigger1 = (var(58)=0&&stateno = 200)||var(58)=1&&(((stateno = [200,225])&&stateno != 215)||((stateno = [400,420])&&stateno != 410))
trigger1 = (movecontact||movereversed)
...
trigger3 = time > ifelse(anim = 195,64,18)
;---------------------------------------------------------------------------
[State -1, Taunt]
type = ChangeState
value = 195
...
trigger2 = stateno != 205 && stateno != 215 && (stateno != [240,242]) && stateno != 430 && stateno != 450||(var(58)=1&&stateno = 450)
trigger3 = stateno = 40 || stateno = 52 || var(58)=1&&stateno=100
trigger4 = stateno = 196
trigger4 = time > ifelse(anim = 195,64,18)
...
trigger8 = (stateno = [200,236]) && (movecontact||movereversed||fvar(28))
...
trigger1 = statetype = A
trigger1 = (ctrl||fvar(28))
trigger2 = (stateno = [600,610]) && var(58)!=2
trigger2 = (movecontact||movereversed) && var(3) = 0
trigger3 = (stateno = 110 && time >= 8) || (stateno = 115 && time >= 5)
trigger4 = stateno = 99 && prevstateno = 610 && var(58)!=2

trigger5 = stateno = 600 && time >= 11

trigger6 = (stateno = [600,640]) && var(58)=2
trigger6 = animtime = 0
...
trigger1 = statetype = A
trigger1 = (ctrl||fvar(28))
trigger2 = stateno = 610 || stateno = 620 || stateno = 630 || stateno = 640
trigger2 = (movecontact||movereversed || var(6)) && var(3) = 0
trigger3 = (stateno = 110 && time >= 8) || (stateno = 115 && time >= 5)
trigger4 = stateno = 99 && (prevstateno = 610 || prevstateno = 620 || prevstateno = 640)
...
trigger2 = (movecontact||movereversed || var(6)) && var(3) = 0
trigger3 = (stateno = 110 && time >= 8) || (stateno = 115 && time >= 5)
trigger4 = stateno = 99 && prevstateno = 620 && var(58)!=2
