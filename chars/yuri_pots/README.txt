...
===========================| Yuri Sakazaki by Phantom.of.the.Server |==========================
 ...
 - Playable in the Ikemen GO engine, April 2024 build and above
...
HARD KNOCKDOWN
 - Ikemen inherits Mugen's native mechanic of allowing a player to press buttons to get up faster after a knockdown
 - This character can sometimes bypass that mechanic and force the enemy to get up after a fixed time
 - When this happens, a "Hard Knockdown" message will be shown (if the lifebars allow it)
...
==========< SPECIAL THANKS >==========
 ...
 - DivineWolf, Foobs, RagingRowen, Toni, Trololo and ZolidSone for feedback
